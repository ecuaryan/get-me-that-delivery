...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen) {
        ...
        this.pages = [
            ...
            { title: 'Place An Order', component: __WEBPACK_IMPORTED_MODULE_4__pages_order_order__["a" /* OrderPage */] },
            { title: 'How It Works', component: __WEBPACK_IMPORTED_MODULE_5__pages_how_it_works_how_it_works__["a" /* HowItWorksPage */] },
            { title: 'Frequently Asked Questions', component: __WEBPACK_IMPORTED_MODULE_6__pages_frequently_asked_questions_frequently_asked_questions__["a" /* FrequentlyAskedQuestionsPage */] },
            { title: 'Contact Us', component: __WEBPACK_IMPORTED_MODULE_7__pages_contact_us_contact_us__["a" /* ContactUsPage */] },
            { title: 'Terms', component: __WEBPACK_IMPORTED_MODULE_8__pages_terms_of_service_terms_of_service__["a" /* TermsOfServicePage */] }
        ];
    }
    ...
    MyApp.prototype.openPage = function (page) {
        if ((this.platform.is('core') || this.platform.is('mobileweb'))) {
            this.nav.push(page.component.name); // this seems to be a hack, using to update the url
        }
